    ...
    try {
      ...
      const created = await request("/api/v1/applications/", {
        ...
        body: {
          ...
          occupation_group_label: job.occupation_group_label || null,
          working_hours_type: job.working_hours_type || null,
          scope_of_work_min: job.scope_of_work_min ?? null,
          scope_of_work_max: job.scope_of_work_max ?? null,
