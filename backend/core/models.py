...
class JobApplication(models.Model):
    ...
    occupation_group_label = models.CharField(max_length=255, blank=True, null=True)
    working_hours_type = models.CharField(max_length=64, blank=True, null=True)
    scope_of_work_min = models.IntegerField(blank=True, null=True)
    scope_of_work_max = models.IntegerField(blank=True, null=True)
