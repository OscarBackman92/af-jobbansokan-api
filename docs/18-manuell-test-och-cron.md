...
**https://ansokt.onrender.com** — byt om du har egen domän.

---

## Del 1 — Cron-jobb på Render

Appen har **två** cron-jobb i `render.yaml`:

| Cron | Schema (UTC) | Kommando | Syfte |
|------|----------------|----------|--------|
| `ansokt-reminders` | Varje dag 06:00 | `send_reminders` + `prune_inactive_accounts` | Dagliga påminnelser + GDPR-gallring |
...
5. Efter deploy: **Dashboard → Cron Jobs** — kontrollera att båda jobben finns:
   - `ansokt-reminders`
...
1. Öppna https://ansokt.onrender.com i mobilwebbläsaren.
...
[ ] Cron ansokt-weekly-summary finns (nytt) + Trigger Run testad
